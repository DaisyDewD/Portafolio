        ...
        <div className="search-result">
          {finalResult.length > 0 ? (
                      ...
                      <div className="search-result-item-taxonomies">
                        ...
                        {item.frontmatter.skills && (
                          <div className="mr-2">
                            ...
                            {item.frontmatter.skills.map((skill, index) => (
                              <span key={skill}>
                                {matchUnderline(skill, searchString)}
                                {item.frontmatter.skills &&
                                  index !==
                                    item.frontmatter.skills.length - 1 && <>, </>}
                              </span>
                            ))}
                          </div>
                        )}
            ...
            <div className="search-result-empty">
              ...
              <p className="mt-4">
                No hay resultados para &quot;<strong>{searchString}</strong>&quot;
              </p>
            </div>
          )}
        </div>
      ) : (
        <div className="py-8 text-center">Escribe algo para buscar...</div>
      )}
    </div>
  );
};
